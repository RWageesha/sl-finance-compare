...
export interface DirectoryBank {
  ...
  /** A separate, icon-cropped variant at public/banks/<slug>-small.<ext>,
   * used for small square avatars (Popular Banks cards, the bank
   * directory grid) instead of scaling down the full logo. Not every
   * bank has one — BankLogo falls back to logoExt when this is unset. */
...
export const DIRECTORY_BANKS: DirectoryBank[] = [
  ...
  },
  {
    ...
    logoExt: 'jpeg'
    // No -small variant provided for BOC — BankLogo falls back to logoExt.
  },
  {
    slug: 'sampath',
    apiName: 'Sampath Bank',
    displayName: 'Sampath Bank',
    type: 'Commercial Bank',
    icon: 'bank',
    tracked: true,
    sourceUrl: 'https://www.sampath.lk/rates-and-charges',
    logoExt: 'png',
    logoSmallExt: 'png'
  },
  {
  ...
  { slug: 'dfcc', displayName: 'DFCC Bank', type: 'Commercial Bank', icon: 'bank', tracked: false, logoExt: 'png', logoSmallExt: 'png' },
  {
    ...
    icon: 'bank',
    tracked: true,
    sourceUrl: 'https://www.peoplesbank.lk/interest-rates/',
    logoExt: 'png',
    logoSmallExt: 'png'
  },
  {
  ...
  {
    slug: 'panasia',
    apiName: 'Pan Asia Banking Corporation',
    displayName: 'Pan Asia Banking Corporation',
    type: 'Commercial Bank',
    icon: 'bank',
    tracked: true,
    sourceUrl: 'https://www.pabcbank.com/fixed-deposits-rates/',
    logoExt: 'png',
    logoSmallExt: 'png'
  },
